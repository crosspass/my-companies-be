...
function Page({ dispatch, company }) {
  ...
  return (
    <div className={styles.mainContainer}>
      ...
      <TotalRevenue reportSummary={company.reportSummaries}/>
      <Increase reportSummary={company.reportSummaries}/>
      <ProfitAbility reportSummary={company.reportSummaries}/>
      <OperationAbility reportSummary={company.reportSummaries}/>
      <FinaRisk reportSummary={company.reportSummaries}/>
    </div>
  );
}
