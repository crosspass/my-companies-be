...
export default function Balance({ balances }) {
  ...
  const totalOption = {
    ...
    legend: {
      data: ['流动资产合计', '非流动资产合计', '流动负债合计', '非流动负债合计', '母公司股东权益合计', '少数股东权益']
    },
    grid: {
      left: '3%',
      right: '4%',
  ...
  const currentOption = {
    ...
    legend: {
      data: ['货币资金', '交易性金融资产', '应收票据及应收账款', '预付款项', '应收利息', '应收股利', '其他应收款', '存货', '合同资产', '持有待售的资产', '一年内到期的非流动资产', '其他流动资产']
    },
    grid: {
      left: '3%',
      right: '4%',
  ...
  const nocurrentOption = {
    ...
    legend: {
      data: ['长期应收款', '长期股权投资', '其他权益工具投资', '其他非流动金融资产', '固定资产合计', '在建工程合计', '无形资产', '商誉', '其他非流动资产']
    },
    grid: {
      left: '3%',
      right: '4%',
  ...
  const currentLiabilitiesOption = {
    ...
    legend: {
      data: ['短期借款', '应付票据及应付账款', '预收款项', '合同负债', '应付职工薪酬', '一年内到期的非流动负债', '其他流动负债']
    },
    grid: {
      left: '3%',
      right: '4%',
  ...
  const nocurrentLiabilitiesOption = {
    ...
    legend: {
      data: ['长期借款', '应付债券', '长期应付款合计', '递延所得税负债', '递延收益-非流动负债']
    },
    grid: {
      left: '3%',
      right: '4%',
